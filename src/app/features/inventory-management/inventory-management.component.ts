...
export class InventoryManagementComponent implements OnInit {
  ...
  activeTab = 'inventory'; // Controla la pestaña activa en móvil ('inventory', 'dishes', 'movements')
  showFilters = false; // Controla la visibilidad del panel de filtros colapsable
