...
export class KitchenComponent implements OnInit, OnDestroy {
  ...
  soundEnabled: boolean = false; // Controla si el sonido está habilitado
  notificationsEnabled: boolean = false; // Controla si las notificaciones están habilitadas
  isFullscreen: boolean = false; // Controla si está en pantalla completa
